<template>
  <div class="card card--section">
    <h1 class="h1--section">Expériences</h1>
    <timeline
        :items="items"
    />
  </div>
    ...
    return {
      items: [
        ...
        },
        {
          ...
          title: 'Dessinateur Industriel chez Métaldur',
          descriptions: [
              "Établir des dessins techniques de produits et outillages internes.",
